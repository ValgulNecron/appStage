...
namespace CartesAcces
{
    public static class  TailleControle
    {
        public static void setTailleControleTexte(Form form)
        {
            ...
            {
                controlsList.Add(controle);
            }
            foreach (Control controle in controlsList.Where(x => x is TextBox))
            {
        ...
        public static void setTailleControleLabel(Form form)
        {
            ...
            foreach (Control controle in controlsList.Where(x => x is FieldDescriptorProto.Types.Label))
            {
        ...
        public static void setTailleBouton(Form form)
        {
            ...
            foreach (Control controle in controlsList.Where(x => x is Button))
            {
